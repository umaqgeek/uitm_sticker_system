                ...
                <div id="menu">
                    ...
                    <!--Fetching Names Of All Students From Database-->
                        ...
                        <?php foreach ($register as $row): ?>
                            <li><a href="<?php echo base_url() . "officer/show_register_id/" . $row->register_id; ?>"><?php echo $row->nama; ?></a></li>
                        <?php endforeach; }?>
                    </ol>
                </div>
                <div id="detail">
                    ...
                    <?php foreach ($single_register as $row): ?>
                        ...
                        <form method="post" action="<?php echo base_url() . "officer/update_register_id1"?>">
