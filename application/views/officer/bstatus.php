        ...
        <div class="row" style="margin-top: 1%;">
            ...
            <div class="col-md-6">
              ...
              <!-- <input type="button" class="btn btn-primary" value="User" onClick="this.form.action='<?=site_url('site/register');?>';this.form.submit()"> -->
               ...
               <input type="button" class="btn btn-primary" value="Submit" onClick="this.form.action='<?=site_url('officer/userstatus');?>';this.form.submit()">
               <input type="button" class="btn btn-primary" value="Kembali" onClick="this.form.action='<?=site_url('officer/home');?>';this.form.submit()">
            </div>
        </div>
